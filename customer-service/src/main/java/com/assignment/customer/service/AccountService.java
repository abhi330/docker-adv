...
public class AccountService {
    ...
    public Account createAccountForCustomer(Account account) {
        try {
            return restTemplate.postForObject(Constants.getACCOUNT_SERVICE_URL() + "/saveAccount", account, Account.class);
    ...
    public void deleteAccount(Long accountId) {
        String deleteAccounturl=Constants.getACCOUNT_SERVICE_URL()+"/deleteAccount/"+accountId;
